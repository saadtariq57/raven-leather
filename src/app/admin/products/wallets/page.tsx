...
export default function Belts() {
  ...
  const [wallets, setWallets] = useState<ProductWithImagesAndSizes[]>([]);
          ...
          {selectedRows.length === 1 && (
            <div className="flex justify-between items-center mb-4 px-6 py-2 bg-gray-200 rounded-md">
              ...
              <div className="flex gap-4">
                <EditWalletDialog productId={wallets[selectedRows[0]].id} />
                <DeleteProductDialog productId={wallets[selectedRows[0]].id} />
              </div>
            </div>
          )}  
