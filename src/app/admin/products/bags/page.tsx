...
import AddBagDialog from "@/components/admin/product/addProductDialogs/AddBagDialog";
import EditBagDialog from "@/components/admin/product/updateProductDialogs/EditBagDialog";
import DeleteProductDialog from "@/components/admin/product/DeleteProductDialog";
import LoadingSpinner from "@/components/LoadingSpinner";

export default function Bags() {
  const [selectedRows, setSelectedRows] = useState<number[]>([]);
  const [bags, setBags] = useState<ProductWithImagesAndSizes[]>([]);
          ...
          {selectedRows.length === 1 && (
            <div className="flex justify-between items-center mb-4 px-6 py-2 bg-gray-200 rounded-md">
              ...
              <div className="flex gap-4">
                <EditBagDialog productId={bags[selectedRows[0]].id} />
                <DeleteProductDialog productId={bags[selectedRows[0]].id} />
              </div>
            </div>
          )}
