...
export default function CheckoutProduct({ product, productQuantity, productSize, address }: CartProps) {
        ...
        try {
            ...
            if (session.status === "authenticated") {
                ...
                const item = [{
                    ...
                    size: productSize === "" ? null : productSize,
                }]
                                        ...
                                        <div className="p-4 text-gray-500 bg-gray-50 flex justify-between items-center">
                                            ...
                                            <Button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    router.push(`/account/address/add?redirect=${encodeURIComponent(`/cart/checkout?${productPath}`)}`)
                                                }} >
                                                {isAddingAddress ? <ButtonLoadingSpinner /> : "Add Address"}
                                            </Button>
                                        </div>
                                    </div>
                                )
                        ...
                        <table className={`w-full ${inter.className}`}>
                            ...
                            <tbody>
                                ...
                                <tr key={product.id} className="border-t">
                                    ...
                                    <td className="p-4 md:p-0">
                                        <div className="flex space-x-4 items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500">{product.color}{productSize ? (", " + productSize) : ""}</p>
                                            </div>
                                        </div>
                                        {/* Mobile View Price & Quantity */}
                                        <div className="mt-4 flex justify-between items-center md:hidden">
                                            <div className="text-base font-semibold md:font-medium">Rs. {Number(product.price).toLocaleString("en-PK")}</div>
                                    ...
                                    {/* Desktop View Price */}
                                    <td className="hidden md:table-cell text-sm xl:text-lg font-medium px-2 py-2">Rs. {Number(product.price).toLocaleString("en-PK")}</td>
                                    ...
                                    {/* Desktop View Total */}
                                    <td className="hidden md:table-cell text-base xl:text-lg font-bold px-4 py-2">Rs. {Number(total).toLocaleString("en-PK")}</td>
                                </tr>
